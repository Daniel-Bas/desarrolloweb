...
<div id="slidey" style="display:none;">
	<ul>
		...
		?>
			<li><img src="images/<?= $row['banner']; ?>" alt=" ">
				<p class='title'><?= $row['titulo']; ?></p>
				<p class='description'><?= $row['sinopsis']; ?> </p>
			</li>
				...
				?>
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							<a href="single.php" class="hvr-shutter-out-horizontal"><img src="images/<?= $row['portada']; ?>" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="single.html"><?= $row['titulo']; ?></a></h6>
								</div>
