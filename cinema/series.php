...
<div class="faq">
	...
	<div class="general_agileits_genres">
		<h4 class="latest-text w3_latest_text">Plataformas</h4>
		<div class="container">
		...
		<div class="container">
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs" role="tablist">
					...
					$sql = "SELECT * FROM plataforma"; //consulta DBMS
					...
					?>
						<li role="presentation" ><a href="#<?= $row['idPlataforma'] ?>" id="<?= $row['idPlataforma'] ?>-tab" role="tab" data-toggle="tab" aria-controls="series.php?id=<?= $row['idPlataforma'] ?>" aria-expanded="true"><?= $row['plataforma']; ?></a></li>
				...
				<div id="myTabContent" class="tab-content">
					<div role="tabpanel" class="tab-pane fade active in" id="1" aria-labelledby="1-tab">
							<!-- pelicula-->
							<?php 
												
								$sql= "SELECT * FROM pelicula where idPlataforma = 1";//consulta DBMS
								$consulta = mysqli_query($conexion, $sql);//ejecuta la consulta
								while($row=mysqli_fetch_array($consulta)){ //recorrer la tabla para mostrar los datos
							?>
					...
					<div role="tabpanel" class="tab-pane fade" id="2" aria-labelledby="2-tab">
						<!-- pelicula-->
							<?php 
												
								$sql= "SELECT * FROM pelicula where idPlataforma = 2";//consulta DBMS
								$consulta = mysqli_query($conexion, $sql);//ejecuta la consulta
								while($row=mysqli_fetch_array($consulta)){ //recorrer la tabla para mostrar los datos
							?>
							<div class="col-md-2 w3l-movie-gride-agile">
					...
					<div role="tabpanel" class="tab-pane fade" id="3" aria-labelledby="3-tab">
						<!-- pelicula-->

						<?php 
												
								$sql= "SELECT * FROM pelicula where idPlataforma = 3";//consulta DBMS
								$consulta = mysqli_query($conexion, $sql);//ejecuta la consulta
								while($row=mysqli_fetch_array($consulta)){ //recorrer la tabla para mostrar los datos
							?>
							<div class="col-md-2 w3l-movie-gride-agile">
