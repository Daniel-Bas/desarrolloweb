						...
						<div id="myTabContent" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
								<div class="agile-news-table">
									...
									<?php 
											$sql= "SELECT COUNT(*)'res'from pelicula";//consulta DBMS
											$consulta = mysqli_query($conexion, $sql); //ejecuta la consulta
											$row = mysqli_fetch_array($consulta)
									?>
										<h4>Numero de peliculas registradas en la plataforma: <span><?= $row['res'];?></span></h4>
									</div>
									<table id="table-breakpoint">
										...
										<tbody>
										<?php 
											$sql= "SELECT * FROM pelicula";//consulta DBMS
											$consulta = mysqli_query($conexion, $sql);//ejecuta la consulta
										...
										<tr class="animate__animated animate__fadeIn">
											...
											<td><img width="60px" src="images/<?= $row['portada'] ?>"></td>
										  	<td><?= $row['titulo'] ?></td>
											<td><?= $row['año'] ?></td>
											<td><?= $row['sinopsis'] ?></td>
											<td><?php
												$sql3= "SELECT * FROM genero WHERE idGenero = $row[idGenero]";//consulta DBMS
												$consulta3 = mysqli_query($conexion,$sql3);//ejecuta la consulta 
												$row3=mysqli_fetch_array($consulta3);                                                                      
												echo $row3['nomGenero'] ;                                      
											?>
											</td>
											<td><?php
												$sql3= "SELECT * FROM pais WHERE idPais = $row[idPais]";//consulta DBMS
												$consulta3 = mysqli_query($conexion,$sql3);//ejecuta la consulta 
												$row3=mysqli_fetch_array($consulta3);                                                                      
												echo $row3['nomPais'] ;                                      
											?>
											...
											<td><?php
												$sql3= "SELECT * FROM plataforma WHERE idPlataforma = $row[idPlataforma]";//consulta DBMS
												$consulta3 = mysqli_query($conexion,$sql3);//ejecuta la consulta 
												$row3=mysqli_fetch_array($consulta3);                                                                      
												echo $row3['plataforma'] ;                                      
											?>
											</td>
											...
											<td> 
												...
												if(isset($_SESSION['usuario']))
													echo '<a class="btn btn-danger" href="eliminar_pelicula.php?id='.$row['idPelicula'].'" ><i class="fa fa-trash"></i></a>';
												?>
